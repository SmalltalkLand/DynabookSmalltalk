...
sqcogspur64linuxht/bin/squeak -vm-display-null Cuis5.0-4426.image -d "[BaseLine instVarNamed: #cache] whileNil: [].BaseLine fileOutSystem." -d "Smalltalk at: #Auto put: #x.Smalltalk snapshot: true andQuit: true clearAllClassState: true."
